        ...
        <div className="mt-6">
          ...
          <div className="mt-4 flex flex-col items-end gap-2 border-t border-border/80 pt-6">
            <div className="flex w-full max-w-[250px] justify-between text-sm">
              ...
              <span className="font-medium">{currency.format(data.subTotal)} đ</span>
            </div>
            <div className="flex w-full max-w-[250px] justify-between text-sm">
              <span className="text-muted-foreground">VAT (8%)</span>
              <span className="font-medium">{currency.format(data.vat)} đ</span>
            </div>
            <div className="flex w-full max-w-[250px] justify-between text-sm">
              <span className="text-muted-foreground">Phí dịch vụ</span>
              <span className="font-medium">{currency.format(data.serviceFee)} đ</span>
            </div>
        ...
        <div className="bg-muted/30 mt-8 grid gap-6 rounded-xl p-6 sm:grid-cols-[1fr_auto]">
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              <h4 className="text-sm font-semibold">Thông tin quan trọng</h4>
              <p className="text-muted-foreground text-sm">
                Vui lòng giữ lại biên lai này cho đến khi nhận phòng. Cảm ơn quý khách đã chọn Continental Grand cho kỳ nghỉ của mình. Hẹn gặp lại quý khách.
              </p>
            </div>
          </div>
