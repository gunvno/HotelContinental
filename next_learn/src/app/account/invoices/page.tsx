                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="border-b border-[#f0ece5]">
                          <th className="pb-4 text-[10px] font-bold tracking-widest text-[#8c8277] uppercase">
                            Mã thanh toán
                          </th>
                          <th className="pb-4 text-[10px] font-bold tracking-widest text-[#8c8277] uppercase">
                            Mã booking
                          ...
                          <th className="pb-4 text-right text-[10px] font-bold tracking-widest text-[#8c8277] uppercase">
                            Thao tác
                          </th>
                        </tr>
                      </thead>
